...
describe('Todo list', () => {
  ...
  it('Should type something partial in the category filter and check that it returned correct elements', () => {
    ...
    let category = page.getTodoCards().map(e => e.element(by.className('todo-card-category')).getText());
  ...
  it('Should type something in the body filter and check that it returned correct elements', () => {
    ...
    let owner = page.getTodoCards().map(e => e.element(by.className('todo-card-owner')).getText());
